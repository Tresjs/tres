...
<template>
  <TresLeches />
  <TresCanvas v-bind="gl" ref="canvas" class="awiwi">
    ...
    <TresMesh v-if="isVisible" :position="[0, 4, 0]" cast-shadow>
      <TresBoxGeometry :args="[1.5, 1.5, 1.5]" />
      <TresMeshToonMaterial color="#4F4F4F" :wireframe="wireframe" />
    </TresMesh>
    <TresMesh :rotation="[-Math.PI / 2, 0, 0]" receive-shadow @click="wireframe = !wireframe">
