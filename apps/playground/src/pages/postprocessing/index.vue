...
import { pmndrsRoutes, threeRoutes } from '@/router/routes/postprocessing'
...
<template>
  <div class="container mx-auto max-w-3xl font-sans text-xs color-gray bg-white">
    <div class="mx-4">
      <div
        class="mt-24 mb-12 text-center justify-between items-center gap-6 sm:mt-16 sm:mb-6 sm:text-left sm:flex sm:flex-row-reverse"
      >
        <div>
          <img
            src="/postprocessing.svg"
            alt="Post-processing logo"
            class="w-24 max-w-36 sm:max-w-xs align-baseline"
          />
        </div>
        <div class="sm:w-2/3">
          <h1
          ...
          <p class="text-lg">Testing zone for post-processing effects</p>
        </div>
      </div>
