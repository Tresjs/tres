...
const PATH =
  'https://raw.githubusercontent.com/Tresjs/assets/d15ced5cf09eddb2dae680dbe993613daae9cea4/textures/rock/'
const { textures } = useTextures(
  ['roughness.jpg', 'normal.jpg', 'displacement.png', 'diffuse.jpg'].map((p) => PATH + p),
)
...
<template>
  ...
  <TresCanvas clear-color="#050505">
    <TresPerspectiveCamera :position="[2, 5, 5]" :fov="70" :look-at="[0, 0, 0]" :dpr="[1, 1.5]" />
    <OrbitControls />

    <TresFog attach="fog" :args="['#191920', 10, 35]" />
    <TresPointLight :intensity="20" :position="[lightX, 2, lightZ]" />
    ...
    <TresGroup :rotation-y="rotationY">
      ...
      <TresMesh :position="[2, 1.0, 1]" :scale="0.5">
