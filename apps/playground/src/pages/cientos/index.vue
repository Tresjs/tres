...
const sections = [
  ...
  { icon: '🚀', title: 'Performance', routes: performanceRoutes },
]
</script>
...
<template>
  <div class="container mx-auto max-w-3xl font-sans text-xs color-gray bg-white">
    <div class="mx-4">
      <div
        class="mt-24 mb-12 justify-between text-center align-baseline items-center gap-6 sm:mt-16 sm:mb-6 sm:text-left sm:flex sm:flex-row-reverse"
      >
        <div>
          <img src="/cientos.svg" alt="Cientos logo" class="max-w-36 sm:max-w-xs align-baseline" />
        </div>
        <div class="sm:w-2/3">
          <h1
          ...
          <p class="text-lg">Testing zone for TresJS/Cientos components</p>
        </div>
      </div>
      ...
      <footer class="py-8">
        <router-link
          to="/"
          class="font-mono block no-underline text-zinc-700 visited:text-zinc-400 hover:text-zinc-600"
          >cd ../</router-link
        >
      </footer>
    </div>
