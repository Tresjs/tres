...
<template>
  ...
  <TresCanvas :tone-mapping="NoToneMapping">
    ...
    <OrbitControls />
    <Image :position-y="2" :url="url" :radius="opacity" :color="new Color('white')">
      <TresBoxGeometry />
    </Image>
    <Image
    ...
    />
    <Image :position-x="2" :scale="[sx, 1]" :url="url" />
    <Image :position-y="-2" :scale="sx" :url="url">
      <TresCircleGeometry />
    </Image>

    <Image :position-x="-2" :url="url" :radius="opacity" :transparent="true" />
  </TresCanvas>
</template>
