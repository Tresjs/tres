...
<template>
  <div ref="wrapperRef" class="aspect-16/9 relative h-full">
    ...
    >
      ...
      <OrbitControls :dom-element="wrapperRef" auto-rotate :auto-rotate-speed="autoRotateSpeed" :target="[0, 0.25, 0]" @change="onChange" />
    ...
    <p class="doc-smaa-info doc-smaa-info-right text-xs font-semibold">With SMAA</p>
  </div>
</template>
