---
title: SMAA
description: Subpixel Morphological Antialiasing — a post-processing antialiasing technique using look-up tables for accurate edge detection.
---
...
::note
**SMAA** generally provides superior visual quality compared to [FXAA](/api/pmndrs/fxaa), though it is slightly less performant. Note that **SMAA** is distinct from **MSAA**.
::
...
| `predicationMode` | Define the predication modes. See the [`PredicationMode`](https://pmndrs.github.io/postprocessing/public/docs/variable/index.html#static-variable-PredicationMode) options. | `PredicationMode.DISABLED` |
