...
You can use [dynamic components](https://vuejs.org/guide/essentials/component-basics.html#dynamic-components) just as you would in Vue.js. There are several ways to do this, but here we’ll follow the official Vue example.
...
::prose-note
You can use [KeepAlive](https://vuejs.org/guide/built-ins/keep-alive.html#keepalive) if you want component instances to be cached and preserved between component switches
::
...
### Wrap the component inside the [`<transition>`](https://vuejs.org/guide/built-ins/transition.html#transition)
