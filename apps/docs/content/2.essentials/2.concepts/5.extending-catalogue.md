...
::tip
For post-processing, consider using [@tresjs/post-processing](https://github.com/Tresjs/tres/tree/main/packages/postprocessing) which provides ready-to-use effect components.
::
