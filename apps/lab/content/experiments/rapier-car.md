---
thumbnail: /experiments/rapier-car.webp
title: Rapier Vehicle
slug: rapier-car
author: [neosoulink, alvarosabu]
status: draft
date: 2026-06-03
featured: false
description: Minimal Rapier ray-cast vehicle controller demo inspired by the official Three.js example. Drive with WASD, brake with Space, reset with R.
tags: ['physics', 'rapier', 'vehicle']
lastUpdated: 2026-07-25
---

Port of the [Three.js Rapier vehicle controller](https://threejs.org/examples/?q=rapier#physics_rapier_vehicle) example to TresJS using `@tresjs/rapier`, turned into a small arena playground inspired by Rocket League.
...
This is a non-commercial, fan-made technical demo for educational purposes, inspired by Rocket League. It is not affiliated with, sponsored, or endorsed by Psyonix LLC or Epic Games. Rocket League and all related trademarks are the property of their respective owners. No original game assets, code, or audio are used.
