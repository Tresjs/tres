    ...
    <div class="relative z-10 h-full flex flex-col">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="w-12 h-12 flex items-center justify-center">
            <div class="w-8 h-8 rounded-full border-2 border-gray-800 relative">
              <div class="absolute inset-1 rounded-full border border-gray-800"></div>
              <div class="absolute top-1/2 left-1/2 w-1 h-1 bg-gray-800 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
            </div>
          </div>
      ...
      <div class="absolute bottom-8 right-8">
        <div class="w-24 h-24 rounded-full border border-gray-800 flex items-center justify-center">
          <div class="w-16 h-16 rounded-full border border-gray-800"></div>
        </div>
      </div>
    </div>
  </div>
