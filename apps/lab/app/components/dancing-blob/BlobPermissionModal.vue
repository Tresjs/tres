    ...
    <template #body>
      <div class="flex flex-col items-center justify-center py-4">
        <p class="max-w-xl text-center">
          Hey! <br />
          This site requires microphone permissions. The microphone is only used to calculate the
          frequency necessary for the blob to dance. A browser pop-up will ask you for permission.
        </p>
        <UButton class="mt-8" color="primary" @click="handleClose"> OK </UButton>
      </div>
    </template>
  </UModal>
</template>
