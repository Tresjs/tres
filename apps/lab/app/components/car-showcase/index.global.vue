...
<template>
  <div class="relative w-full h-full">
    ...
    <div class="absolute bottom-20 left-20">
      ...
      <p class="text-white text-sm mt-2 font-mono">
        Ported from R3F's original
        <NuxtLink href="https://codesandbox.io/p/sandbox/lwo219" target="_blank" class="underline"
          >sandbox</NuxtLink
        >
        by <NuxtLink href="https://x.com/0xca0a" target="_blank" class="underline">0xca0a</NuxtLink>
      </p>
    </div>
  </div>
</template>
