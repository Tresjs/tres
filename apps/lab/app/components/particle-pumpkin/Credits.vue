  ...
  <div class="z-50 bottom-0 fixed flex justify-center w-screen sm:justify-start text-white">
    ...
    >
      ...
      <div class="flex flex-row gap-3 md:gap-5">
        <NuxtLink to="https://twitter.com/@drew_ronsman"
                  target="_blank"
                  title="Twitter"
        ...
        <NuxtLink to="https://github.com/NeoPrint3D/TresJsHalloweenPumpkin"
                  target="_blank"
        ...
        <NuxtLink to="https://www.youtube.com/channel/UC_90-lqmmcymEHKNdZC1leA"
                  target="_blank"
                  title="YouTube"
                  class="flex items-center gap-0.5"
        >
      ...
      <NuxtLink to="https://dronsman.com"
                target="_blank"
