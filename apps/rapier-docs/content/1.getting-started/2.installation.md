...
description: Get started with rapier tres.js
---

## Manual installation

If you prefer to set up **Rapier tres.js** manually or add it to an existing [Tres.js](https://tresjs.org/) project
