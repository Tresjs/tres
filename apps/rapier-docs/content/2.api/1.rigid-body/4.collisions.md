...
::prose-note
For a complete explanation check [Collision groups and solver groups](https://rapier.rs/docs/user_guides/javascript/colliders#collision-groups-and-solver-groups)
::
...
```html
<BallCollider :args="[1, 1, 1]" activeCollision @collision-enter="onCollisionEnter" />
```
