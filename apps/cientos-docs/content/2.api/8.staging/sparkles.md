...
| **sequenceColor**           | Type: `Gradient<TresColor>`<br>Default: `[[0.7, '#82dbc5'], [0.8, '#fbb03b']]`<br><br>'_Sequence' props: specify how a particle changes as it "progresses". See also "mix_" props.<br>Color sequence as particles progress                                                                                                                                                                                                                                                                                                     |
