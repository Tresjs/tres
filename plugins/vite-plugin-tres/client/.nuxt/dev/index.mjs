...
import { renderToString } from 'file:///Users/alvarosabu/Projects/tres/core/node_modules/.pnpm/vue@3.4.3_typescript@5.3.3/node_modules/vue/server-renderer/index.mjs';
...
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/alvarosabu/Projects/tres/core/node_modules/.pnpm/ofetch@1.3.3/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/alvarosabu/Projects/tres/core/node_modules/.pnpm/destr@2.0.2/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/alvarosabu/Projects/tres/core/node_modules/.pnpm/unenv@1.8.0/node_modules/unenv/runtime/fetch/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/alvarosabu/Projects/tres/core/plugins/vite-plugin-tres/client/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/alvarosabu/Projects/tres/core/plugins/vite-plugin-tres/client","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/alvarosabu/Projects/tres/core/plugins/vite-plugin-tres/client/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/alvarosabu/Projects/tres/core/plugins/vite-plugin-tres/client/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/alvarosabu/Projects/tres/core/plugins/vite-plugin-tres/client/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/alvarosabu/Projects/tres/core/plugins/vite-plugin-tres/client/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file:///Users/alvarosabu/Projects/tres/core/plugins/vite-plugin-tres/client/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/alvarosabu/Projects/tres/core/plugins/vite-plugin-tres/client/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
