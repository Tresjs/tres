export const DECAL_DEBUG_UI_STYLES = String.raw`
.cientos-decal-ui,
.cientos-decal-ui * {
...
.cientos-decal-ui .tint-color-input::-webkit-color-swatch-wrapper { padding: 0; }
.cientos-decal-ui .tint-color-input::-webkit-color-swatch { border: none; border-radius: 6px; }
.cientos-decal-ui .tint-color-input::-moz-color-swatch { border: none; border-radius: 6px; }
