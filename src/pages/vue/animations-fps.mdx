...
thumbnail: /animations-fps.png
title: FPS
author: Alvarosabu
description: A basic explanation of FPS
tags: ['fps', 'animations', 'useRendererLoop']
---

import FPSExample from '/@/components/fps/FPSExample.vue'
import TheInfo from '/@/components/TheInfo.astro'

<FPSExample client:only />
