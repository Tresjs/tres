...
describe("nodeOps", () => {
  ...
  describe("createElement", () => {
    it("should create an instance with given tag", async () => {
      // Setup
      const tag = "TresMesh";
      const props = { args: [] };
    ...
    it("should create an instance with given tag and props", async () => {
      // Setup
    ...
    it.skip("should create an camera instance", async () => {
      // Setup
    ...
    it.skip("should log a warning if the camera doesnt have a position", async () => {
      // Setup
      const tag = "TresPerspectiveCamera";
      const props = { args: [75, 2, 0.1, 5] };
    ...
    it("should add attach material property if instance is a material", () => {
      // Setup
    ...
    it("should add attach geometry property if instance is a geometry", () => {
      // Setup
      const tag = "TresTorusGeometry";
      const props = { args: [] };
  ...
  describe("insert", () => {
    it("should insert child into parent", async () => {
      // Setup
  ...
  describe("patchProp", () => {
    it("should patch property of node", async () => {
      // Setup
    ...
    it("should patch traverse pierced props", async () => {
      // Setup
      const node: TresObject = new Mesh();
      node.__tres = {
        root: {
    ...
    it("should not patch traverse pierced props of existing dashed properties", async () => {
      // Setup
      const node: TresObject = new Mesh();
      node.__tres = {
        root: {
