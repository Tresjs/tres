...
export * from './types'
import { useTresContext, type TresContext } from './provider'
...
export { TresContext as TresState, useTresContext, normalizeColor, normalizeVectorFlexibleParam, templateCompilerOptions }
