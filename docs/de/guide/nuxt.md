...
- Konfiguriert automatisch den Vue-Compiler, um TresJS-Komponenten zu unterstützen, siehe [warum](/guide/troubleshooting.html#fehler-beim-auflosen-des-komponenten-trescomponent)?
