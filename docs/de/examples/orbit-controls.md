...
[OrbitControls](https://threejs.org/docs/index.html?q=orbit#examples/en/controls/OrbitControls) sind ein Kamerasteuerungselement, das es dir ermöglicht, dich frei um ein Ziel herum zu bewegen. Es ist eine großartige Möglichkeit, deine Szene zu erkunden.
