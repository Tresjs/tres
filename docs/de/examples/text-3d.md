...
Allerdings ist es kein Teil des Kerns von ThreeJS. Daher müsstest du es aus dem Modul `three/addons/geometries/TextGeometry` importieren.
...
Standardmäßig beginnt der Text in ThreeJS an der Ausgangsposition des Meshs, also wenn es [0,0,0] ist, wird der Text dort beginnen, aber wir können ihn einfach zentrieren, indem wir das Flag "center" übergeben.
