  ...
  return computed(() =>
    resolveUnref(
      !Array.prototype.findLast
        ...
        : resolveUnref(list).findLast((element, index, array) => fn(resolveUnref(element), index, array)),
    ),
  )
}
...
function computedAsync(evaluationCallback, initialState, optionsOrRef) {
  ...
  const { lazy = false, evaluating = void 0, shallow = false, onError = noop } = options
...
var __defNormalProp$n = (obj, key, value) =>
  key in obj
    ? __defProp$n(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function useStorage(key, defaults2, storage, options = {}) {
  ...
  function read(event) {
    ...
    if (rawValue == null) {
      ...
      else if (type === 'object' && !Array.isArray(value)) return __spreadValues$k(__spreadValues$k({}, rawInit), value)
      return value
...
function useRefHistory(source, options = {}) {
  ...
  const manualHistory = useManualRefHistory(
    source,
    __spreadProps$62(__spreadValues$h({}, options), { clone: options.clone || deep, setSource }),
  )
...
var __objRest$22 = (source, exclude) => {
  var target = {}
  for (var prop in source)
    if (__hasOwnProp$g.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
...
function useFetch(url, ...args) {
  ...
  if (args.length > 0) {
    if (isFetchOptions(args[0])) options = __spreadValues$d(__spreadValues$d({}, options), args[0])
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      fetch(
        context.url,
        __spreadProps$32(__spreadValues$d(__spreadValues$d({}, defaultFetchOptions), context.options), {
          headers: __spreadValues$d(
            __spreadValues$d({}, headersToObject(defaultFetchOptions.headers)),
...
function useFocus(target, options = {}) {
  ...
  const focused = computed({
    ...
    set(value) {
      var _a2, _b
      if (!value && innerFocused.value) (_a2 = targetElement.value) == null ? void 0 : _a2.blur()
...
var __objRest$12 = (source, exclude) => {
  var target = {}
  for (var prop in source)
    if (__hasOwnProp$82.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
  if (source != null && __getOwnPropSymbols$82)
    for (var prop of __getOwnPropSymbols$82(source)) {
      if (exclude.indexOf(prop) < 0 && __propIsEnum$82.call(source, prop)) target[prop] = source[prop]
    }
  return target
}
...
var __spreadValues$72 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$72.call(b, prop)) __defNormalProp$72(a, prop, b[prop])
...
function usePointerLock(target, options = {}) {
  ...
  async function lock(e, options2) {
    ...
    targetElement =
      e instanceof Event ? ((_a2 = unrefElement(target)) != null ? _a2 : triggerElement.value) : unrefElement(e)
